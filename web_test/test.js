...
async function renderVotePage() {
        ...
        const partyListHTML = parties.map(party => `
            <li class="party-item">
               ...
               <button class="button vote-btn" data-party="${party.token}">Vote</button>
            </li>
            ...
            <div class="login-page">
                <div class="modal">
                    ...
                    <div class="login-container">
                        ...
                        <button class="learn-more" id="login-submit">Login</button>
        ...
        app.innerHTML = `
            <div class="official-page">
               <div class="modal">
                ...
                <div class="button-container">
                    <button class="button" id="add-candidate-btn">Add Candidate</button>
                    <button class="button" id="get-details-btn">Get Details</button>
                </div>
            </div>
        <button class="button" id="back-btn">Back</button>
        </div>
